...
export const DOC_SPECS: Record<DocType, DocSpec> = {
  formulario: {
    ...
    fields: [
      ...
      // Sección 3: Inscripción en el Registro de Propiedades del CBR.
      { key: "fojas", hint: "Sección 3: Fojas de la inscripción en el CBR" },
      { key: "numero_inscripcion", hint: "Sección 3: Número de la inscripción en el CBR" },
      { key: "anio_inscripcion", hint: "Sección 3: Año de la inscripción en el CBR" },
      { key: "conservador", hint: "Sección 3: 'CBR de' — comuna del Conservador donde está inscrito" },
      // Sección 4: Deslindes (Norte, Sur, Oriente/Este, Poniente/Oeste).
      { key: "deslinde_norte", hint: "Sección 4: descripción del deslinde Norte, tal cual" },
      { key: "deslinde_sur", hint: "Sección 4: descripción del deslinde Sur, tal cual" },
      { key: "deslinde_oriente", hint: "Sección 4: descripción del deslinde Oriente (o Este), tal cual" },
      { key: "deslinde_poniente", hint: "Sección 4: descripción del deslinde Poniente (o Oeste), tal cual" },
    ],
  },
  avaluo: {
  ...
  cbr: {
    ...
    fields: [
      ...
      { key: "conservador", hint: "Comuna del Conservador (CBR) donde está inscrito" },
      { key: "rol_predio", hint: "Rol del predio si aparece" },
      { key: "comuna", hint: "Comuna del predio" },
      { key: "superficie", hint: "Superficie del predio con unidad" },
      { key: "deslinde_norte", hint: "Descripción del deslinde Norte, tal cual" },
      { key: "deslinde_sur", hint: "Descripción del deslinde Sur, tal cual" },
      { key: "deslinde_oriente", hint: "Descripción del deslinde Oriente (o Este), tal cual" },
      { key: "deslinde_poniente", hint: "Descripción del deslinde Poniente (o Oeste), tal cual" },
